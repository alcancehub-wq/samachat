    ...
    translations: {
      ...
      contactModal: {
        ...
        form: {
          ...
          numberHelper: "Use DDD ou DDI. Exemplos: 11912345678 (Brasil) ou 14155552671 (internacional). Pode colar com +, espaços ou parênteses.",
          numberPlaceholder: "11912345678 ou 14155552671",
          email: "Email",
          emailHelper: "Opcional. Usado para contato e avisos.",
          allowMultipleConversations: "Permitir múltiplas conversas",
          allowMultipleConversationsHelper:
            "Use apenas para contatos internos, equipe, fornecedores, parceiros ou números de teste. Quando desativado, o SamaChat impede que outro atendente inicie nova conversa com este mesmo número se já houver atendimento anterior vinculado a outro usuário.",
          tags: "Tags",
      ...
      dialogModal: {
        ...
        form: {
          ...
          description: "Descrição",
          template: "Template",
          templateHelper: "Use {{variavel}} para campos dinâmicos. Se houver arquivo, este texto será enviado como legenda ou apoio.",
          media: "Arquivo anexado",
          mediaHelper: "Anexe áudio, imagem, vídeo ou documento ao diálogo. O texto acima continua opcional como legenda ou mensagem de apoio.",
          mediaUpload: "Anexar arquivo",
          mediaReplace: "Trocar arquivo",
          mediaRemove: "Remover arquivo",
          mediaPreview: "Visualizar arquivo atual",
          active: "Ativo",
          inactive: "Inativo",
          variables: "Variaveis",
          variableKey: "Chave",
      ...
      metaTemplates: {
        ...
        empty: {
          noOfficialConnection: "Nenhuma conex\u00e3o oficial dispon\u00edvel.",
          noTemplates: "Nenhum template encontrado para esta conex\u00e3o.",
        },
      },
      campaigns: {
        title: "Campanhas",
        ...
        toasts: {
          ...
          activated: "Campanha ativada com sucesso.",
          deactivated: "Campanha desativada com sucesso.",
        },
        confirmationModal: {
          deleteTitle: "Excluir",
          deleteMessage: "Tem certeza? Esta ação não pode ser desfeita.",
      ...
      contactSelect: {
        ...
        selectedHint: "Os contatos selecionados continuam na lista mesmo quando não aparecem no filtro de busca.",
        noneSelected: "Nenhum contato selecionado ainda.",
      ...
      settings: {
        ...
        settings: {
          ...
          lostTicketPurge: {
            name: "Depuração de perdidos",
            description: "Defina a política administrativa que será usada pela futura rotina segura de depuração automática de tickets perdidos.",
            enabledLabel: "Ativar depuração automática de perdidos",
            amountLabel: "Tempo de retenção",
            amountHelper: "Informe quantos dias ou meses os tickets perdidos devem ser mantidos antes de uma futura depuração segura.",
            unitLabel: "Unidade",
            warningTitle: "Aviso importante",
            warning: "Quando habilitado, tickets marcados como perdidos poderão ser depurados definitivamente após o período configurado. A rotina de depuração será executada por processo seguro.",
            options: {
              enabled: "Ativado",
              disabled: "Desativado",
            },
      ...
      messagesInput: {
        ...
        internalComposer: {
          title: "Escrever anotação interna",
          helper:
            "A anotação não é visível para o cliente. Mencione outros usuários da sua conta digitando @+email",
      ...
      scheduleModal: {
        ...
        form: {
          ...
          ticketLookup: "Cliente / atendimento",
          scheduledAt: "Agendamento",
          status: "Status",
          assignee: "Responsável",
          assigneePlaceholder: "Sem responsável",
        ...
        search: {
          placeholder: "Busque por nome ou numero do cliente",
          helper: "Pesquise em atendimentos abertos e pendentes visiveis para voce.",
          typeToSearch: "Digite ao menos 2 caracteres para buscar.",
          noOptions: "Nenhum atendimento ativo visivel foi encontrado para essa busca.",
          loading: "Buscando atendimentos...",
          ticketRequired: "Selecione um atendimento valido para agendar.",
          selected: "Atendimento selecionado",
          statusOpen: "Aberto",
      ...
      backendErrors: {
        ...
        ERR_WAPP_NOT_INITIALIZED:
          "A conexão do WhatsApp ainda não está pronta. Aguarde concluir a inicialização ou reconecte na página de conexões.",
        ...
        ERR_DUPLICATED_CONTACT: "Já existe um contato cadastrado com este número. Use o contato existente ou mescle os duplicados antes de continuar.",
        ...
        ERR_DIALOG_CONTENT_OR_MEDIA_REQUIRED: "Preencha uma mensagem ou anexe um arquivo ao diálogo.",
