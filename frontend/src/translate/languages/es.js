    ...
    translations: {
      ...
      contactModal: {
        ...
        form: {
          ...
          numberHelper: "Use codigo de area o codigo internacional completo. Ejemplos: 11912345678 (Brasil) o 14155552671 (internacional). Puede pegarlo con +, espacios o paréntesis.",
          numberPlaceholder: "11912345678 o 14155552671",
          email: "Correo Electrónico",
          emailHelper: "Opcional. Usado para contacto y avisos.",
          registration: "Registro",
          pendingRegistration: "Registro pendiente. Complete los campos obligatorios para continuar la transferencia.",
          city: "Ciudad",
          state: "Estado",
          captureChannel: "Canal de captación",
          captureChannelHelper: "Informe cómo llegó este contacto a la empresa.",
          wasReferred: "¿Fue referido?",
          wasReferredHelper: "Informe si este contacto llegó por recomendación.",
          ...
          referralPartnerHelper: "Informe el nombre del socio.",
          referralNote: "Observación de la recomendación",
          referralNoteHelper: "Opcional.",
      ...
      contactListModal: {
        ...
        form: {
          ...
          previewContactsHint: "{{count}} cliente(s) coinciden con los filtros actuales. Desmarca quien debe quedar fuera.",
          previewLoading: "Cargando clientes...",
          previewEmpty: "No se encontraron clientes con los filtros actuales.",
          contacts: "Contactos",
        },
        buttons: {
          okAdd: "Agregar",
      ...
      dialogModal: {
        ...
        form: {
          ...
          description: "Descripcion",
          template: "Template",
          templateHelper: "Usa {{variable}} para campos dinamicos. Si hay un archivo adjunto, este texto se envia como leyenda o apoyo.",
          media: "Archivo adjunto",
          mediaHelper: "Adjunta audio, imagen, video o documento al dialogo. El texto superior sigue siendo opcional como leyenda o apoyo.",
          mediaUpload: "Adjuntar archivo",
          mediaReplace: "Cambiar archivo",
          mediaRemove: "Quitar archivo",
          mediaPreview: "Ver archivo actual",
          active: "Activo",
          inactive: "Inactivo",
          variables: "Variables",
          variableKey: "Clave",
      ...
      messageVariablesHelper: {
        ...
        hint: "Haz clic en una variable para insertarla en el texto.",
        items: {
          ...
          goodMorning: "Texto fijo Buenos dias",
          goodAfternoon: "Texto fijo Buenas tardes",
      ...
      campaigns: {
        ...
        toasts: {
          ...
          activated: "Campaña activada correctamente.",
          deactivated: "Campaña desactivada correctamente.",
        },
        confirmationModal: {
          deleteTitle: "Eliminar",
          deleteMessage: "Estas seguro? Esta accion no se puede deshacer.",
      ...
      contactSelect: {
        ...
        selectedHint: "Los contactos seleccionados siguen en la lista aunque no aparezcan en el filtro de búsqueda actual.",
        noneSelected: "Aún no hay contactos seleccionados.",
      ...
      messagesInput: {
        ...
        placeholderInternal:
          "Escriba un mensaje interno visible solo para el equipo.",
        signMessage: "Firmar",
      ...
      scheduleModal: {
        ...
        form: {
          ...
          ticketId: "Ticket",
          contactId: "Contacto",
          ticketContext: "Atención",
          contactName: "Cliente",
          monthlyRecurring: "Repetir mensualmente",
          recurringMonths: "Meses adicionales",
          recurringMonthsHelp: "Crea copias mensuales a partir de la fecha inicial.",
        },
        buttons: {
          okAdd: "Agregar",
          okEdit: "Guardar",
        ...
        search: {
          placeholder: "Busca por nombre o numero del cliente",
          helper: "Busca en tickets abiertos y pendientes visibles para ti.",
          typeToSearch: "Escribe al menos 2 caracteres para buscar.",
          noOptions: "No se encontro ningun ticket activo visible para esta busqueda.",
          loading: "Buscando tickets...",
          ticketRequired: "Selecciona un ticket valido antes de guardar el agendamiento.",
          selected: "Ticket seleccionado",
          statusOpen: "Abierto",
          statusPending: "Pendiente",
        },
        success: "Agendamiento guardado correctamente.",
        successMultiple: "{{count}} agendamientos guardados correctamente.",
      },
      flows: {
        title: "Flowbuilder",
      ...
      backendErrors: {
        ...
        ERR_DUPLICATED_CONTACT: "Ya existe un contacto registrado con este número. Usa el contacto existente o fusiona los duplicados antes de continuar.",
        ...
        ERR_DIALOG_CONTENT_OR_MEDIA_REQUIRED: "Agrega un mensaje o adjunta un archivo al dialogo.",
