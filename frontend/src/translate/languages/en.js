    ...
    translations: {
      ...
      contactModal: {
        ...
        form: {
          ...
          numberHelper: "Use area code or full country code. Examples: 11912345678 (Brazil) or 14155552671 (international). You can paste it with +, spaces, or parentheses.",
          numberPlaceholder: "11912345678 or 14155552671",
          email: "Email",
          emailHelper: "Optional. Used for contact and notices.",
          allowMultipleConversations: "Allow multiple conversations",
          allowMultipleConversationsHelper:
            "Use this only for internal contacts, team members, suppliers, partners, or test numbers. When disabled, SamaChat prevents another agent from starting a new conversation with this same number if there is already prior service assigned to another user.",
          tags: "Tags",
      ...
      dialogModal: {
        ...
        form: {
          ...
          description: "Description",
          template: "Template",
          templateHelper: "Use {{variable}} for dynamic fields. If a file is attached, this text is sent as caption or support text.",
          media: "Attached file",
          mediaHelper: "Attach audio, image, video, or document to the dialog. The text above remains optional as caption or support text.",
          mediaUpload: "Attach file",
          mediaReplace: "Replace file",
          mediaRemove: "Remove file",
          mediaPreview: "Preview current file",
          active: "Active",
          inactive: "Inactive",
          variables: "Variables",
          variableKey: "Key",
      ...
      messageVariablesHelper: {
        ...
        items: {
          ...
          queue: "Queue name",
          goodMorning: "Fixed text Good morning",
          goodAfternoon: "Fixed text Good afternoon",
          goodEvening: "Fixed text Good evening",
      ...
      metaTemplates: {
        ...
        empty: {
          noOfficialConnection: "No official connection available.",
          noTemplates: "No templates found for this connection.",
        },
      },
      campaigns: {
        title: "Campaigns",
      ...
      contactSelect: {
        ...
        selectedHint: "Selected contacts remain in the list even when they are hidden by the current search filter.",
        noneSelected: "No contacts selected yet.",
        showAll: "Show all",
      },
      quickAnswers: {
        title: "Shortcuts",
      ...
      scheduleModal: {
        ...
        search: {
          ...
          helper: "Search open and pending tickets visible to you.",
          typeToSearch: "Type at least 2 characters to search.",
          noOptions: "No visible active ticket was found for this search.",
          loading: "Searching tickets...",
          ticketRequired: "Select a valid ticket before saving the schedule.",
      ...
      backendErrors: {
        ...
        ERR_DIALOG_CONTENT_OR_MEDIA_REQUIRED: "Add a message or attach a file to the dialog.",
